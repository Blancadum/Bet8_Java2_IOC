...
public class Constants {
    ...
    public static final String MESSAGE_DEFAULT_EVENT_DELETED = "Desenvolupament eliminat correctament!";
    ...
    public static final String OP6_ELIMINAR_EVENT = "6. Eliminar un desenvolupament\n";
