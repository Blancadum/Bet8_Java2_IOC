...
public class Constants {
    ...
    public static final String MESSAGE_DEFAULT_ASK_TYPE = "Introdueix el tipus d'esport:";
    public static final String MESSAGE_DEFAULT_SPORT = "Introdueix el tipus d'esport:";
    public static final String MESSAGE_DEFAULT_ASK_NAME = "Introdueix el nom de l'esdeveniment:";
    ...
    public static final String ERROR_EVENT_NAME = "El nom de l'desenvolupament ha de contenir almenys una lletra";
    public static final String ERROR_BETTOR_NAME = "El nom de l'apostant ha de contenir almenys una lletra";
    ...
    public static final String ERROR_EVENT_ID_NOT_FOUND = "No existeix cap desenvolupament amb l'ID: ";
    public static final String ERROR_BET_EXISTS = "ja té una aposta en aquest desenvolupament.";
    public static final String ERROR_ID_INVALID = "ID no vàlid";

    // === MENSAJES DE ÉXITO ===
    public static final String ID_EVENT_OK = "Desenvolupament afegit correctament amb ID: ";
    ...
    public static final String REGEX_NO_NUMBERS = ".*\\d+.*";
    ...
    public static final String LIST_HEADER = "DATETIME     SPORT       DESENVOLUPAMENT        JUGADOR           TIPUS                      QUOTES    IMPORT";
    public static final String TEMP_LIN = "-------------------------------------------------------------------------------------------------------------";
    public static final String BET_BOARD_FORMAT = "%-12s %-11s %-18s %-18s %-25s %7s %9s";
    public static final String EMPTY_SPACE = "";

    // === MENU ===
    public static final String OP1_AFEGIR_DESENVOLUPAMENT = "1. Afegir un desenvolupament\n";
    public static final String OP2_AFEGIR_APOSTA = "2. Afegir una aposta a un desenvolupament\n";
